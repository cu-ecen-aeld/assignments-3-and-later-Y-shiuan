...
SVC_NAME="actions.runner.cu-ecen-aeld-assignments-3-and-later-Y-shiuan.Ubuntu.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (cu-ecen-aeld-assignments-3-and-later-Y-shiuan.Ubuntu)"
